class Game {
  ...
  start() {
    ...
    this.addSprites(powerGrass, 18, powerCoinImage, 0.2);
  ...
  handlePowerGrass(index) {
    animals[index - 1].overlap(powerGrass, function(collector, collected) {
      animal.score += 21;
      animal.update();
      //collected is the sprite in the group collectibles that triggered
      //the event
